...
CONCEPTS = {
    # --- fisica / modelado ---
    "marco-dq":              ["marco dq", "transformada de Park"],
    "transformada-clarke":   ["transformada de Clarke"],
    "filtro-lcl":            ["filtro LCL"],
    "resonancia-lcl":        ["resonancia del filtro LCL", "resonancia LCL"],
    "red-thevenin-scr":      ["equivalente Thévenin", "red Thévenin", "Thévenin", "red débil"],
    "convertidor-vsc":       ["convertidor VSC", "VSC"],
    "sistema-trifasico":     ["sistema trifásico"],
    "modelo-promediado":     ["modelo promediado"],
    ...
    "modulacion-pwm":        ["modulación PWM", "PWM"],
    "generador-sincrono":    ["generador síncrono"],
    "carga-potencia-constante-cpl": ["carga de potencia constante", "CPL"],
    "microrred-hibrida-ac-dc": ["microrred híbrida"],
    "impedancia-dq-vs-secuencia": ["impedancia dq"],
    ...
    "amortiguamiento-activo-lcl": ["amortiguamiento activo"],
    ...
    "impedancia-salida-estabilidad": ["estabilidad por impedancia", "impedancia de salida"],
    "no-pasividad-resistencia-negativa": ["resistencia negativa", "no pasividad"],
    ...
    "estabilidad-bus-dc-cpl": ["estabilidad del bus DC", "bus DC"],
    ...
    "estabilidad-armonica":  ["estabilidad armónica"],
    "oscilaciones-subsincronas": ["oscilaciones subsíncronas"],
